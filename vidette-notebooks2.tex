...
\costas{1. I agree with this point. Is there a way to add this: \url{https://czarifis.github.io/vidette-prototype/Thesis\%20Proposal\%20Sample.html} prototype into the paper?
	2. Not sure how to answer this. The language with the constructs can describe data access, data processing/transformations and data visualization. The analyst doesn't have to know anything about the MVVM design pattern in order to create this analysis.}
